...
export function ProductDetailDrawer() {
  ...
  const lowStock = stock <= product.minStock;
      ...
      <div className="space-y-4 text-sm">
        <section className="overflow-hidden rounded-lg border border-border">
          ...
          <div className="grid grid-cols-3 divide-x divide-border bg-white">
            ...
            <div className="p-3"><p className="text-[11px] text-muted">Danh mục</p><p className="mt-1 truncate font-medium">{product.category}</p></div>
